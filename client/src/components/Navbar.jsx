...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-4'>
      <Link to='/'><img src={assets.logo}   className="w-28 sm:w-32 lg:w-40"  alt="Logo" /></Link>  

      <div>
        {
            user ? <div className='flex items-center gap-2 sm:gap-3 '>
                <button onClick={()=>navigate('/buy')}className='flex items-center gap-2 sm:gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3
                ...
                <div className='relative group'>
                    ...
                    <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black cursor-pointer
                   rounded  pt-12'>
